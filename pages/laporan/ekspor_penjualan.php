...
?>
      <table width="100%" align="center" border="0">
                                  <tr>
                                    ...
                                    <span style="font-size: 20px;font-weight: bold;"><center>Laporan Penjualan </center></span>
                                     <span style="font-size: 20px;font-weight: bold;"><center> Per Tgl                                                                                                       <?php echo date('d-m-Y', strtotime($_GET['tgl1']));
                                                                                                       echo ' s/d ';
                                                                                                       echo date('d-m-Y', strtotime($_GET['tgl2'])); ?></center></span>
                                <br>
      <table id="tablepkb1" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <?php
                    ...
                    $j        = 1;
                    $jml      = 0;
                    $sqlcatat = " SELECT DISTINCT k.tgl_kwitansi as tgl,k.no_kwitansi,k.fk_pkb as no_pkb,p.fk_no_polisi as no_polisi
