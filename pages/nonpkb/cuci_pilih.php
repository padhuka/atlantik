  <?php
    ...
    <div id="ModalPilihcuci" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> <div class="modal-dialog">
      <div class="col-md-14">
                ...
                <?php
                        ...
                        <tr>
                          ...
                          <td>
                                        <button type="button" class="btn btn btn-default btn-circle" onclick="pilihcucie('<?php echo $catat['id_cuci'];?>','<?php echo $catat['nama'];?>','<?php echo $catat['harga_jual'];?>','<?php echo $hartot;?>','<?php echo $catat['diskon'];?>');">Pilih</button>
