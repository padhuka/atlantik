...
<div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalpaycuci" style="text-align: center;padding-right: 0px">Tambah Data Payment Non PKB<button type="button" class="close" aria-label="Close" onclick="$('#ModalAdd').modal('hide');"><span>&times;</span></button></h4>  
                    </div>
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formpaycuci">
                      ...
                      <!--
                        ...
                        <div class="form-group" id="showPkb">
                          <div class="col-sm-3">
                            <label for="namapkb">No Refx</label>
                          </div>
                            <div class="col-sm-7">
                          ...
                          <div class="col-sm-3">
                            <label for="partnerpaycuci">Partner paycuci</label>
                          </div>
                            <div class="col-sm-7">
                                <!-- <input type="hidden" class="form-control" id="nopkb" name="asuransi">  -->
                                <input type="text" class="form-control" id="namapartner" name="namapartner" readonly> 
                                <input type="hidden" class="form-control" id="id_partner_paycuci" name="id_partner_paycuci" readonly> 
                                 </div>
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="nilai" name="nilai" required readonly="yes">
                          </div>
                        </div>
