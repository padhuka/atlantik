      ...
      <table id="paycuci" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <tr>
                          ...
                          <th><button type="button" class="btn btn btn-default btn-circle" onclick="open_addpaycuci();"><span>Tambah</span></button></th>
                </tr>
                </thead>
                <tbody>
                <?php
                        ...
                        <tr>
                          ...
                          <td >
                                         ...
                                         <button type="button" class="btn btn btn-default btn-circle" id="<?php echo $catat['no_bukti']; ?>" onclick="cetak_paycuci(nobukti='<?php echo $catat['no_bukti']; ?>');"><span>Cetak</span></button>
