<?php
    ...
    $id = $_GET['nobukti'];
    $sqlemp = "SELECT * FROM t_paycuci WHERE no_bukti='$id'";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px">Batal Penerimaan Non PKB <button type="button" class="close" aria-label="Close" onclick="$('#ModalBatal').modal('hide');"><span>&times;</span></button></h4> 
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formpaycuci">
                                        <div class="alert alert-danger">Apakah anda yakin ingin membatalkan Perimaan Non PKB ( <?php echo $id;?>) ?</div>
                ...
                <script type="text/javascript">
                  $(document).ready(function (){
                        $(".save_submit").click(function (e){
                           ...
                           $.ajax({
                                url: 'paycuci/paycuci_del_save.php?no_bukti=<?php echo $id;?>&keteranganbatal='+keteranganbatal,
                                type: 'GET',
