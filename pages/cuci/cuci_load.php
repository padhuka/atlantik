      ...
      <table id="example1" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <?php
                        ...
                        <tr>
                          ...
                          <td >
                                        <button type="button" class="btn btn btn-default btn-circle" id="<?php echo $catat['id_cuci']; ?>" onclick="open_modal(ideditas='<?php echo $catat['id_cuci']; ?>');"><span>Edit</span></button>
                                         <button type="button" class="btn btn btn-default btn-circle" id="<?php echo $catat['id_cuci']; ?>" onclick="open_del(iddelas='<?php echo $catat['id_cuci']; ?>');"><span>Hapus</span></button>
