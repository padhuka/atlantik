...
<div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Cuci Mobil</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          <div class="col-sm-3">
                            <label for="kodecuci">Kode Cuci Mobil</label>
                          </div>
                          <div class="col-sm-8">
                            <input type="text" class="form-control" id="id_cuci" name="id_cuci" required>
                          </div>
                        </div>
				                <div class="form-group">
                          <div class="col-sm-3">
